package com.guoxun.airbaba.widget;
...
public abstract class NineGridLayout extends ViewGroup {
    ...
    protected static final int MAX_W_H_RATIO = 3 / 2;
    ...
    protected void setOneImageLayoutParams(RatioImageView imageView){
        int width = mTotalWidth;
        int height = mTotalWidth  * 2 / 3;
