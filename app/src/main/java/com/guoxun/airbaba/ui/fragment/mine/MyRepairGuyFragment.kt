...
import com.guoxun.airbaba.ui.activity.mine.repair.MyRepairGuyDetailsActivity
 ...
 */
class MyRepairGuyFragment : BaseFragment(){
...
//    private val mPresenter by lazy { FollowListPresenter() }
    ...
    companion object {
        fun setInstance(type: Int): MyRepairGuyFragment {
            val fragment = MyRepairGuyFragment()
            val bundle = Bundle()
...
//            addItemDecoration(DividerItemDecoration(context, DividerItemDecoration.VERTICAL))
        ...
        mAdapter!!.setOnItemClickListener { adapter, view, position ->
            //            val item : FollowListEntity.ListsBean = adapter.getItem(position) as FollowListEntity.ListsBean
                startActivity(Intent(context, MyRepairGuyDetailsActivity::class.java))
        }
        /**
         * OnItemClickListener
         * */
