...
import com.guoxun.airbaba.ui.adapter.home.ActivityMessageAdapter
...
/**
  ...
  */
class ActivityMessageActivity : BaseActivity(){
    private var baseList = ArrayList<String>()
    private val mAdapter by lazy { ActivityMessageAdapter(baseList) }
