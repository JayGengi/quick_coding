...
class CollectionGoodsFragment : BaseFragment(){
    ...
    private val mAdapter by lazy { activity?.let { CollectionGoodsAdapter( baseList) } }
//    private val mPresenter by lazy { FollowListPresenter() }

    companion object {
        fun setInstance(type: Int): CollectionGoodsFragment {
            val fragment = CollectionGoodsFragment()
            val bundle = Bundle()
