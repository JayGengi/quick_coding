...
import com.guoxun.shanzuo.utils.DensityUtil;
 ...
 * {@link #setViewPager(ViewPager)} providing it the ViewPager this activity_home_search.layout is being used for.
 * <p>
 ...
 * providing the activity_home_search.layout ID of your custom activity_home_search.layout.
 */
public class SlidingTabLayout extends HorizontalScrollView {

    /**
     * Allows complete control over the colors drawn in the tab activity_home_search.layout. Set with
    ...
    /**
     * Set the custom activity_home_search.layout to be inflated for the tab views.
     *
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                // If there is a custom tab view activity_home_search.layout id set, try and inflate it
